  ...
  const projectsData = [
    {
      ...
      projectDescription:
        "Welcome to CarHub, your one-stop destination for hassle-free car rentals. Powered by Next.js, Tailwind CSS, and TypeScript, our user-friendly platform offers a curated catalog of cars for rent. Experience convenience, style, and reliability with our seamless rental service. Start your journey with us today!",
      projectTech: [
        "React",
        "Redux Toolkit",
        "SCSS",

...
function Projects() {
  const projectsData = [
...

    {
      ...
      projectExternalLinks: {
        github: "Introducing my first React portfolio site! Powered by React.js, SCSS, JavaScript, and Socket.io, it showcases my projects and skills in a dynamic and interactive way. Explore my journey now.",
        externalLink: "https://3d-model-site.netlify.app/",
      },
    },

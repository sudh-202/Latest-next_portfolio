      ...
      <div className="about-grid">
        <div className="about-grid-info">
          <p className="about-grid-info-text">
            Bonjour! My name is Sudhanshu, and I am passionate about new 
            designs and  content for the web. My interest in web development was
            sparked in 2020 when I created my first project called cusine finderr, a
            restaurant app built using React and Node.js.
          </p>
          <p className="about-grid-info-text">
          ...
          <p className="about-grid-info-text">
            ...
            <Link
              className="link"
              target="_blank"
              href="https://car-hub-2023.vercel.app/"
            >
              CarHub,
            </Link>
          ...
          <ul className="about-grid-info-list">
            ...
            <li className="about-grid-info-list-item">JWT</li>
        ...
        <div className="about-grid-photo">
          ...
          <div className="about-grid-photo-container">
            <Image src="/aboutus.svg" alt="profile" fill />
          </div>
        </div>
      </div>
    </motion.div>

...
function Projects() {
  const projectsData = [
    ...
    },
    {
      ...
      projectLink: "https://netlify.com",
      projectDescription:
        "NewImageGeneration: Elevate your visuals with HTML, SCSS, and JavaScript. Our OpenAI-powered platform generates stunning images, transforming your ideas into captivating graphics effortlessly. Explore boundless creativity today.",
      projectTech: [
        "HTML",
        "Javascript",
        "SCSS",

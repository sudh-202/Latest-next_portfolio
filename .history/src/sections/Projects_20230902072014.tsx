  ...
  const projectsData = [
    {
      ...
      projectDescription:
        " A Next state-of-the-art modern application that leverages all of the latest and greatest of what Next 13 has to offer, leveraging features such as server-side rendering and the app router.",
      projectTech: [
        "React",
        "Redux Toolkit",
        "SCSS",
